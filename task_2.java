...
public void checkIsAdultWhenAgeIsLessThan18False() {
    ...
    assertEquals("Возраст  меньше 18, должно возвращаться значение false", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True() {
    ...
    assertEquals("Возраст  равен 18, должно возвращаться значение true", true, isAdult);
}
